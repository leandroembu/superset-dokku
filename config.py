...
WTF_CSRF_ENABLED = os.environ.get("SUPERSET_WTF_CSRF_ENABLED")
...
EMAIL_NOTIFICATIONS = os.environ.get("SUPERSET_EMAIL_NOTIFICATIONS") or False
SMTP_HOST = os.environ.get("SUPERSET_SMTP_HOST") or "localhost"
SMTP_STARTTLS = os.environ.get("SUPERSET_STARTTLS") or False
SMTP_SSL = os.environ.get("SUPERSET_SMTP_SSL") or False
SMTP_USER = os.environ.get("SUPERSET_SMTP_USER")
SMTP_PORT = os.environ.get("SUPERSET_SMTP_PORT")
SMTP_PASSWORD = os.environ.get("SUPERSET_SMTP_PASSWORD")
SMTP_MAIL_FROM = os.environ.get("SUPERSET_SMTP_MAIL_FROM")
# If True creates a default SSL context with ssl.Purpose.CLIENT_AUTH using the
# default system root CA certificates.
SMTP_SSL_SERVER_AUTH = os.environ.get("SUPERSET_SMTP_SSL_SERVER_AUTH") or False
ENABLE_CHUNK_ENCODING = os.environ.get("SUPERSET_ENABLE_CHUNK_ENCODING") or False
...
WEBDRIVER_AUTH_FUNC = os.environ.get("SUPERSET_WEBDRIVER_AUTH_FUNC") or None
BROWSER_CONTEXT_AUTH_FUNC = os.environ.get("SUPERSET_BROWSER_CONTEXT_AUTH_FUNC") or None
...
# for details
#
SESSION_COOKIE_HTTPONLY = os.environ.get("SUPERSET_SESSION_COOKIE_HTTPONLY") or True
SESSION_COOKIE_SECURE = os.environ.get("SUPERSET_SESSION_COOKIE_SECURE") or False
SESSION_COOKIE_SAMESITE: os.environ.get("SUPERSET_SESSION_COOKIE_SAMESITE")
